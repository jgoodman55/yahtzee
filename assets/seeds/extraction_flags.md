...
- game 2, jordan, chance: 21 written over crossed-out 20. Jordan photo-review → 20; recorded_total 208.
- game 2, jordan, recorded_total: written 208; seed now 208 after chance 21→20.
- game 3, jordan, twos: Jordan photo-review → 0; recorded_total 149 (was 155).
...
- game 2, jordan, three_of_a_kind: Jordan photo-review → 13; recorded_total 193.
...
|-------|------|--------|----------|------|
| IMG_2894 | 2 | erin | yahtzee / chance | Jordan photo-review: yahtzee 25→0, chance 0→25. recorded_total still 125. |
...
- **IMG_2905** game 2 / erin / `chance`: Jordan photo-review → 19; recorded_total 193.
...
- **IMG_2909** game 2 / erin / `fours`: Jordan photo-review → 16; recorded_total 280 (matches written grand total).
...
- **IMG_2910** game 3 / erin / `small_straight`: Written 20 (non-standard). Jordan photo-review → 30; recorded_total 171.
...
Photo-review corrections (recorded_total recomputed from category sums):
(8,erin) swap yahtzee↔chance, total 322; (14,jordan,chance) 21→20, 208;
(15,jordan,twos) →0, 149; (23,jordan,three_of_a_kind) →13, 193;
(29,erin) yahtzee 25→0 / chance 0→25, 125; (41,erin) threes→3 / fours→16, 225;
(42,jordan,threes) →9, 265; (45,jordan,ones) →3, 152;
(62,erin,chance) →19, 193; (66,jordan,ones) →1, 228;
(69,erin,twos) →6, 160; (74,erin,fours) →16, 280;
...
## IMG_2912
- game 1, jordan, yahtzee_bonus: one tick/slash in first bonus checkbox was scored 100. Jordan photo-review → 0; recorded_total 299 (yahtzee 50 still included).
