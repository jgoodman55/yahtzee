...
Strategy tab (108 games, 0 ties) after `dac serve --template yahtzee-dark`:
...
- `pub_map_london_visit_bubbles.jpg` — Leaflet + Esri light-gray map; bubbles sized by unique-day visits
